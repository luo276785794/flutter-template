package com.wenlong.template.flutter
...
class FlutterTemplateProviderImpl : WizardTemplateProvider() {

    override fun getTemplates(): List<Template> = listOf(fluttersTemplate)

    private val fluttersTemplate: Template
        get() = template {
            revision = 1
            name = "Flutter Templates"
            description = "一键创建 Flutter 单个页面所需要的全部组件"
            ...
            //创建所需文件
            recipe = { te ->
                flutterRecipe(this@FlutterTemplateProviderImpl, (te as ModuleTemplateData))
            }
        }
